...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("crisspm51@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "crisspm51@gmail.com";  // Correo Electrónico
    $mail->Password = "crisspm51@gmail.com36856296"; // Contraseña del correo
